 ...
 * 
 * RIX MODS:
 * [A] OPTION FOR HOW TO LOAD THE .PROPERTIES FILE (MINOR)
 * [B] USE SwingUtilities.invokeLater() (MINOR)
 * [C] ADD JFRAME TITLE (MINOR)
 * [-] FORMATTED SOURCE CODE (MINOR)
 * 
...
public class JTypeSafeTester extends JFrame {
    ...
    public JTypeSafeTester() {
        ...
        try {
            // [A] rix mod - using option to select; use resource bundle from within most IDEs (Eclipse)
            int option = 1;
            SwingConfigurationManager mng = (option == 1)
                    ? new SwingConfigurationManager( ResourceBundle.getBundle("gr.zeus.tests.mygui") )
                    : new SwingConfigurationManager( "mygui.properties" );
